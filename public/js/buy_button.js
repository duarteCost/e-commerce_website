...
$( document ).ready(function() {
    ...
    $(".buttuns").append('<button onclick="document.getElementById(\'id01\').style.display=\'block\'" type="button" class = "buyNow" style="vertical-align:middle"><span>Buy Now</span></button>');
